                ...
                <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                    ...
                    <div class="hidden sm:ml-6 sm:block">
                        <div class="flex space-x-4">
                            ...
                            <a href="#" class="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Ajouter</a>
    ...
    <main class="container mx-auto mt-8">
        <div class="flex flex-wrap justify-between">
            <div class="w-full md:w-8/12 px-4 mb-8">
                <img src="{{asset(Auth::user()->logo)}}" alt="Featured Image" class="w-full h-64 object-cover rounded">
                ...
                <div class="flex flex-wrap gap-4">
                    ...
                    <!-- Exemple de carte d'événement -->

                    <div class="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5 px-4 mb-4">
                        <div class="bg-white p-4 rounded shadow">
                            <!-- Image de l'événement -->
                            <img src="" alt="Event Image" class="w-full h-40 object-cover rounded mb-2">

                            <!-- Date de l'événement -->
                            <p class="text-gray-600 text-sm">Nom Evenements</p>
            ...
            <div class="w-full md:w-4/12 px-4 mb-8">
                ...
                <div class="mt-5">
                    ...
                    <a href="" class="bg-green-500  text-white font-bold py-2 px-4 rounded mr-3">
                        Modifier l'article
                    </a>

                    <a href="" class="bg-red-500 text-white font-bold py-2 px-4 rounded">
                        Supprimer l'article
                    </a>
