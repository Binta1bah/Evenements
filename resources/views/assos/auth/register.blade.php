<x-guest-layout>
    <form method="POST" action="{{ route('registerAssos') }}" enctype="multipart/form-data">
        @csrf
        ...
        <div>
            ...
            <x-text-input id="slogan" class="block mt-1 w-full" type="test" name="slogan" :value="old('slogan')" required autofocus autocomplete="slogan" />
